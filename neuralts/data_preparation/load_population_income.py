...
def load_population_income_data(input_path: str) -> pd.DataFrame:
    ...
    columns = ['Year', 'Population', 'Average_Income_EUR']
...
if __name__ == "__main__":
    ...
    input_path = os.path.join(os.getcwd(), "data", "raw", "statistisches_bundesamt", "population.csv")
    output_path = os.path.join(os.getcwd(), "data", "processed", "population_income_germany.parquet")
